...
scene_defaults = {
    'Go2': ('building2_9_go2', [-5.5, 6.0, 0.5], [2.0, -3.0, 4.5]),
}
...
path_pub = node.create_publisher(Path, "/pct_path", QoSProfile(depth=1, durability=DurabilityPolicy.TRANSIENT_LOCAL))
